...
It intentionally uses plain HTML, CSS, and JavaScript so GitHub Pages can serve it without a build step. The publisher copies `commentary-review-sdk.js` into the repository root before pushing.
